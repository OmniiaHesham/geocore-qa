...
describe('GeoCore - Upload GeoPackage Dataset (Step 1)', () => {
  ...
  it('completes Step 1 with a GeoPackage upload', () => {
    workspacesPage.ClickOnUploadFile();
    createnewfile_stepone.enterlayerinfo(
      "Automated GPKG Layer",
      "Automated test to upload GeoPackage dataset to Geocore"
    );
    createnewfile_stepone.handlePopupIfExistsAndChoose();

    createnewfile_stepone
      .uploadFile('datasets/pa_order_2.gpkg')
